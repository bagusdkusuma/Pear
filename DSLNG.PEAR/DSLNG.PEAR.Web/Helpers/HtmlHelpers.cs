...
namespace DSLNG.PEAR.Web.Helpers
{
    public static class HtmlHelpers
    {
        ...
        public static MvcHtmlString DisplayKpiInformationInput(this HtmlHelper htmlHelper, IList<DerValuesViewModel.KpiInformationValuesViewModel> kpiInformations, int position, int tabIndex, string placeholder = "rate",string defaultValueDefined = "empty", string type = "daily-actual")
        {
            string value;
